<?php
	...
	$giatu = isset($_REQUEST["giatu"]) ? $_REQUEST["giatu"] : '';
	$giaden = isset($_REQUEST["giaden"]) ? $_REQUEST["giaden"] : '';						
	
	$cate = "";
	if($danhmuc != 0)
	{
		$cate = "and id_dm='$danhmuc'";
	}
	...
	if($giatu != 0)
	{
		$fromto = "and gia_sp >= '$giatu'";
	}
	
	$fromto1 = "";
	if($giaden != 0)
	{
		$fromto1 = "and gia_sp <= '$giaden'";
	}
					
	$sqlnc = $cate.$fromto.$fromto1;
            ...
            <div class="col-xs-12 col-sm-8 col-md-9">
                <div class="col-xs-12 col-sm-12 list_pro" style="clear: both;">
                        <div class="area-title">
                            <h3> Sản phầm đã tìm thấy</h3>
                        </div>
                        <div class="featured-product">
                            <div class="featured-item">
                            <!-- Start featured item -->
				            <?php 
				            $query = "select * from sanpham where id $sqlnc order by gia_sp desc";
				            //echo $query;die();
